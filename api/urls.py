...
router.register(r'tipo-montaje', views.TipoMontajeViewSet, basename='tipomontaje')
...
urlpatterns = router.urls + [
    ...
    path('reservacion/<int:pk>/checklist-almacenista/', views.ChecklistAlmacenistaView.as_view(), name='checklist_almacenista'),
    path('reservacion/<int:pk>/checklist-coordinador/', views.ChecklistCoordinadorView.as_view(), name='checklist_coordinador'),
    ...
    path('estados-inventario/', views.EstadosInventarioView.as_view(), name='estados_inventario'),
]
