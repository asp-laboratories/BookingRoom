...
urlpatterns = [
    ...
    path('administracion/paquetes/crear/', views.crear_paquete, name="crear_paquete"),
    path('administracion/paquetes/<int:pk>/editar/', views.editar_paquete, name="editar_paquete"),
    path('administracion/paquetes/<int:pk>/eliminar/', views.eliminar_paquete, name="eliminar_paquete"),
    path('administracion/paquetes/<int:pk>/duplicar/', views.duplicar_paquete, name="duplicar_paquete"),
    path('administracion/paquetes/<int:pk>/detalle/', views.obtener_detalle_paquete, name="detalle_paquete"),
